...
// every verb to an m-<engine> driver binary over the neutral contract
// (internal/driver), instead of building a yottadb/iris argv for an in-process
...
func NewVista(kind Kind, client *driver.Client) *VistaEngine {
...
func (e *VistaEngine) RunScript(ctx context.Context, script string) (Result, error) {
